...
class IEVRAnalysis:
    ...
    def calculate_ievr(self, ticker, earnings_date, analysis_days_before=30, underlying_price=None, include_spx=True):
        """
        Calculate Implied Earnings Volatility Ratio (IEVR).
        Args:
            ticker: Stock ticker
            ...
            include_spx: Whether to also calculate S&P 500 IEVR (default True)
        Returns:
